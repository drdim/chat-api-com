...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.chat-api.com/instance';
     ...
     * @return $this
     */
    public function setInstanceId($key)
    {
        $this->instanceId = $key;
        return $this;
    }
    ...
    {
        return isset($this->instanceId) ? $this->instanceId : '';
    }
    ...
    {
        $report = 'PHP SDK (ChatApiCom\Client) Debug Report:' . PHP_EOL;
